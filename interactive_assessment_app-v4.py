...
st.markdown('<h1 class="main-title">แบบทดสอบประเมินผลอิงสถานการณ์ (Scenario-Based Assessment)</h1>', unsafe_html=True)
st.markdown('<h3 class="sub-title">สำหรับตำแหน่ง Software Quality Assurance / Tester (จำกัด 5,000 ตัวอักษรต่อข้อ)</h3>', unsafe_html=True)
...
questions = [
    ...
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1563013544-824ae1d704d3?auto=format&fit=crop&w=1200&q=80",
        "rubric": [
...
for q in questions:
    ...
    # Question Prompt
    st.markdown(f'<div class="question-prompt">{q["prompt"]}</div>', unsafe_html=True)
...
with st.expander("🖼️ วิธีเปลี่ยนหรือแก้ไขรูปภาพโจทย์ในแต่ละข้อ (สำหรับนักพัฒนา)"):
    st.markdown("""
    หากต้องการเปลี่ยนรูปภาพประกอบโจทย์ทั้ง 5 ข้อในอนาคต คุณสามารถแก้ไขค่าของคีย์ `"image_url"` ในโค้ดไฟล์ `interactive_assessment_app-v4.py` ได้ง่ายๆ:
...
st.markdown('<div class="footer-text">พัฒนาโดย Gemini Notebook — แพลตฟอร์มวิเคราะห์และประเมินคุณภาพซอฟต์แวร์อิงสถานการณ์</div>', unsafe_html=True)
